...
# IMG_ROOT = '/Users/mitchmathieu/documents/cisc499/code/voxelnet/data/image/training/image_2/'
# IMG_ROOT = '/Users/mitchmathieu/documents/cisc499/code/voxelnet/data/validation/image_2/'
# PC_ROOT = '/media/hdc/KITTI/point_cloud/raw_bin_files/training/velodyne/'
# PC_ROOT = '/Users/mitchmathieu/documents/cisc499/code/voxelnet/data/point_cloud/training/velodyne/'
# PC_ROOT = '/Users/mitchmathieu/documents/cisc499/code/voxelnet/data/validation/velodyne/'
# CALIB_ROOT = '/media/hdc/KITTI/calib/data_object_calib/training/calib/'
# CALIB_ROOT = '/Users/mitchmathieu/documents/cisc499/code/voxelnet/data/data_object_calib/training/calib/'
...
#     if frame<10:
#         output_name = '{}00000{}.bin'.format(PC_ROOT, frame)
#     elif frame<100:
#         output_name = '{}0000{}.bin'.format(PC_ROOT, frame)
#     elif frame<1000:
#         output_name = '{}000{}.bin'.format(PC_ROOT, frame)
#     else:
#         output_name = '{}00{}.bin'.format(PC_ROOT, frame)
